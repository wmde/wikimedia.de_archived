...
<main class="imprint limit--20 center-column cp--h1 cp--t3-5 cp--b2">
	<div class="limit--12 cp--h1 cp--t0-5 cp--b1 sc--white">
		...
		<p class="tm--beta">
			<?= $t("Dieses Impressum gilt für die Domains wikimedia.de und
wikipedia.de.  Bitte beachten Sie, dass Wikimedia Deutschland nicht der
Diensteanbieter aller auf dieser Website genannten Wikimedia-Projekte ist.") ?>
		</p>
		...
		<section class="cp--t1">
			...
			<p class="tm--beta">
				...
				10963 Berlin<br>
				<?= $t('E-Mail:') ?> <a href="mailto:info@wikimedia.de" class="link--black">info@wikimedia.de</a><br>
				<?= $t("Telefon") ?>: +49 (0)30-219 15 826-0<br>
				<?= $t('Fax') ?>: +49 (0)30-219 158 26-9<br><br>
				<span class="tm--alpha t--strong"><?= $t("Geschäftsführender Vorstand") ?>:</span> Abraham Taherivand<br>
					<?= $t("Eingetragen im Vereinsregister des Amtsgerichts
Charlottenburg, VR 23855.  Inhaltlich Verantwortlicher gemäß § 55 Abs. 2 RStV:
{:name} (Anschrift wie oben).", ['name' => 'Abraham Taherivand']) ?>
			</p>
		</section>
		...
		<section class="cp--t1">
			...
			<p class="tm--beta">
				<?= $t("Personenbezogene Daten werden auf dieser Webseite nur
im technisch notwendigen Umfang erhoben. In keinem Fall werden die erhobenen
Daten verkauft oder aus anderen Gründen an Dritte weitergegeben. Im Folgenden
erhalten Sie einen Überblick über die von uns im Rahmen dieser Website
erhobenen Daten.") ?>
				<ul>
					<li class="tm--beta">
						<?= $t("Log-Files: Bei der Nutzung dieses Angebots
werden die von Ihrem Browser an den Server übermittelten Daten erfasst und
gespeichert.  Dies umfasst üblicherweise Informationen über den Typ und die
Version des von Ihnen verwendeten Browsers, das verwendete Betriebssystem, die
Referrer URL (die Webseite, von der aus Sie zu dieser Website gelangt sind),
den Hostnamen des zugreifenden Rechners (die IP Adresse) sowie die Uhrzeit der
Serveranfrage. In der Regel lassen sich diese Daten nicht bestimmten Personen –
...
Daten zusammengeführt. Die Daten werden regelmäßig nach einer statistischen
Auswertung gelöscht.") ?>
					</li>
					<li class="tm--beta">
						<?= $t("Cookies: Diese Website verwendet an mehreren
Stellen Cookies.  Cookies sind kleine Textdateien, die Ihr Browser speichert
und die dazu dienen, die Benutzung einer Website einfacher, effektiver und
sicherer zu machen. Cookies richten auf Ihrem Rechner keinen Schaden an, nehmen
minimalen Speicherplatz in Anspruch und enthalten keine Viren.") ?>
					</li>
					<li class="tm--beta">
						<?= $t("Google Analytics: Diese Website benutzt Google
...
folgenden Link") ?>
						...
						<?= $t("Google Analytics: Diese Website benutzt Google
Analytics, einen verfügbare Browser-Plugin herunterladen und installieren.  Sie
...
Ihrer Daten beim Besuch dieser Website verhindert:") ?>
						...
						<?= $t("Nähere Informationen zu Nutzungsbedingungen und
Datenschutz finden Sie unter") ?>
						...
						<?= $t(" Wir weisen Sie darauf hin, dass auf dieser
...
anonymisierte Erfassung von IP-Adressen (sog. IP-Masking) zu gewährleisten.  ") ?>
		...
		<section class="cp--t1">
			...
			<p class="tm--beta">
				...
				<?= $t('Fax') ?>: +49 (0)30-219 158 26-9<br>
				<?= $t('E-Mail:') ?> <a href="mailto:info@wikimedia.de" class="link--black">info@wikimedia.de</a>
			</p>
		</section>
	</div>
</main>